...
func newAppLog(db *gorm.DB, opts ...gen.DOOption) appLog {
	...
	_appLog.AppInstalledId = field.NewInt64(tableName, "app_installed_id")
	_appLog.Content = field.NewString(tableName, "content")
	_appLog.CreatedAt = field.NewTime(tableName, "created_at")
...
func (a *appLog) updateTableName(table string) *appLog {
	...
	a.AppInstalledId = field.NewInt64(table, "app_installed_id")
...
func (a *appLog) fillFieldMap() {
	...
	a.fieldMap["id"] = a.ID
	a.fieldMap["app_installed_id"] = a.AppInstalledId
