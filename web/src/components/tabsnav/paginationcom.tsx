...
export function PaginationCom({ 
    ...
    return (
        <div className="flex items-center justify-end lg:gap-4 md:gap-4 text-sm mr-6 lg:mt-6 md:mt-6 mt-6">
            ...
            <div className="items-center gap-2 lg:flex md:flex flex">
                ...
                <Input
                    ...
                    onBlur={handleJump}
                    className="border  active:border-gray-200 rounded w-9 px-2 mx-0.5 py-1"
                />
                <span>页</span>
            </div>
        </div>
